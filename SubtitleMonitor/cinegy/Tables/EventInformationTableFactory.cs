...
namespace Cinegy.TsDecoder.Tables
{
    public class EventInformationTableFactory : TableFactory
    {
        ...
        /// </summary>
        public List<EventInformationItem> EventInformationItems { get; set; }

        public EventInformationTableFactory ()
	    {
        ...
        public void AddPacket(TsPacket packet)
        {
            ...
            if (packet.PayloadUnitStartIndicator)
            {
                ...
                {
                    System.Console.WriteLine("EventInformationTable AddPacket too few bytes");
                }
                else
                {
                    ...
                    if ((EventInformationTable == null) || (EventInformationTable.VersionNumber != InProgressTable.VersionNumber))
                    {
