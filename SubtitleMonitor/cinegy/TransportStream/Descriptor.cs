...
//            public string ServiceTypeString => ServiceTypeDescription(ServiceType);
            ...
            {
                return ServiceTypeDescription(ServiceType);
            }
        }
...
//        public string ServiceTypeDescription => GetServiceTypeDescription(ServiceType);
        ...
        {
            return GetServiceTypeDescription(ServiceType);
        }
    ...
    public class ComponentDescriptor : Descriptor
    {
        ...
        {
            return GetComponentDescription(StreamContent, StreamContentExt, ComponentType);
        }
    }
    /// <summary>
    ...
    public class SatelliteDeliverySystemDescriptor : Descriptor
    {
        ...
        {
            return string.Format("{0} GHz", Frequency.Insert(3, ","));
        }
        public string OrbitalPosition { get; set; }
        public string OrbitalPositionString()
        {
            return string.Format("{0} deg", OrbitalPosition.Insert(3, ","));
        }
        public bool WestEastFlag { get; set; }
        public byte Polarization { get; set; }
        public byte RollOff { get; set; }
        public string RollOffString()
        {
            return RoleOffDescription[RollOff];
        }
        public string PolarizationString()
        {
            return PolarizationDescription[Polarization];
        }
        public bool ModulationSystem { get; set; }
        public string ModulationSystemString()
        {
            return ModulationSystem ? "S2" : "S";
        }
        public byte Modulation { get; set; }
        public string ModulationString()
        {
            return ModulationDescription(Modulation);
        }
        public string SymbolRate { get; set; }
        public byte FECInner { get; set; }
        public string FECInnerString()
        {
            return FECInnerDescription(FECInner);
        }
    }
    /// <summary>
    ...
    public class TerrestrialDeliverySystemDescriptor : Descriptor
    {
        ...
        {
            return BandwidthDescription[Bandwidth];
        }
        public byte ReservedFutureUse { get; set; }
        public byte Constellation { get; set; }
        public string ConstellationString()
        {
            return ConstellationDescription[Constellation];
        }
        public byte HierarchyInformation { get; set; }
        public string HierarchyInformationString()
        {
            return HierarchyInformationDescription[HierarchyInformation];
        }
        public byte CodeRateHPStream { get; set; }
        public string CodeRateHPStreamString()
        {
            return CodeRateDescription[CodeRateHPStream];
        }
        public byte CodeRateLPStream { get; set; }
        public string CodeRateLPStreamString()
        {
            return CodeRateDescription[CodeRateLPStream];
        }
        public byte GuardInterval { get; set; }
        public string GuardIntervalString()
        {
            return GuardIntervalDescription[GuardInterval];
        }
    ...
    public class CueIdentifierDescriptor : Descriptor
    {
        ...
        public string CueStreamTypeString()
        {
            return CueStreamTypeDescription(CueStreamType);
        }
    }
    /// <summary>
    ...
    public class ParentalRatingDescriptor : Descriptor
    {
        ...
        public ICollection<int> ParentalRatings { get; set; }
    }
    /// <summary>
    ...
    public class LcnDescriptor : Descriptor
    {
        ...
        public IEnumerable<LogicalchannelnumberItem> LogicalChannelNumbers { get ; set; }
    }
    /// <summary>
    ...
    public class AACDescriptor : Descriptor
    {
        ...
        public int AACTypeFlag { get; set; }
        public bool SAOCDETypeFlag { get; set; }
        public byte AACType { get; set; }
        public byte[] AdditionalInfoBytes { get; set; }
    ...
    public class DTSDescriptor : Descriptor
    {
        ...
        public int SamplerateCode { get; set; }
        public int Bitrate { get; set; }
        public int NumberOfBlocks { get; set; }
        public int FrameSize { get; set; }
        public int SuroundMode { get; set; }
        public int LFEFlag { get; set; }
        public int ExtendedSurroundFlag { get; set; }
        public byte[] AdditionalInfoBytes { get; set; }
    }
