...
namespace Cinegy.TsDecoder.TransportStream
{
    public class TsPacketFactory
    {
        ...
        {
            if (data == null) throw new ArgumentNullException(NameOf.nameof(() => data));
        ...
        {
            if (tsData == null) throw new ArgumentNullException(NameOf.nameof(() => tsData));
